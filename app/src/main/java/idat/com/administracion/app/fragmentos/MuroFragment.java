 ...
 * Use the {@link MuroFragment#newInstance} factory method to
...
public class MuroFragment extends Fragment {
    ...
    public static MuroFragment newInstance(String param1, String param2) {
        MuroFragment fragment = new MuroFragment();
